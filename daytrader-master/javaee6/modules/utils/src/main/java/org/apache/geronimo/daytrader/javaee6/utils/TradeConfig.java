...
public class TradeConfig {
   ...
   //Disable Web JDBC&JPA public static String[] runTimeModeNames = {"Full EJB3", "Direct (JDBC)", "Session (EJB3) To Direct", "Web JDBC", "Web JPA"};    
    ...
    public static int orderProcessingMode = ASYNCH_2PHASE;
    ...
    public static String DS_NAME = "jdbc/datasources/TradeDataSource";
    ...
    public static String DATASOURCE = "jdbc/datasources/TradeDataSource";
    ...
    private static int primIterations = 5;
