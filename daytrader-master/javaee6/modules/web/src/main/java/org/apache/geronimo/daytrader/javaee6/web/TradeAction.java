        ...
        if (TradeConfig.runTimeMode == TradeConfig.EJB3) {
            try {
                ...
                if ((trade == null) ||
                    ...
                    try {
                    //    trade = (TradeServices) context.lookup("java:global/daytrader/web/TradeSLSBBean!org.apache.geronimo.daytrader.javaee6.web.ejb3.TradeSLSBLocal");
            ...
            try {
                ...
                if ((trade == null) ||
                    ...
                    InitialContext context = new InitialContext();
                    try {
                    //    trade = (TradeServices) context.lookup("java:global/daytrader/web/DirectSLSBBean!org.apache.geronimo.daytrader.javaee6.web.ejb3.DirectSLSBLocal");
